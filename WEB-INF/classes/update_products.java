...
public class update_products extends HttpServlet {
	...
	{
		DBHelper.doUpdate("update on_hand set on_hand_quantity=on_hand_quantity-"+Integer.parseInt(cart[i+1])+" where sku='"+cart[i]+"'");
